<aside class="w-64 bg-[#222831] text-[#EEEEEE] flex flex-col shadow-xl rounded-tr-2xl">
    ...
    <nav class="flex-1 px-4 py-6 space-y-1.5">
        ...
        <!-- MENU LAPORAN - TAMBAHAN BARU -->
        <a href="{{ route('reports.index') }}" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('reports.*') ? 'bg-[#00ADB5] text-white shadow-md' : 'hover:bg-[#393E46] hover:text-white' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
